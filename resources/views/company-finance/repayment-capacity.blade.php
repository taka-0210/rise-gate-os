            ...
            <tbody>
                @foreach($rows as $row)
                    <tr>
                        ...
                        <td><span class="capacity-type {{ $row['type'] === '実績' ? 'actual' : ($row['type'] === '未登録' ? 'missing' : 'plan') }}">{{ $row['type'] }}</span></td>
