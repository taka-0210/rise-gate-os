    ...
    <section class="panel stack">
        ...
        <form class="stack" method="POST" action="{{ route('projects.improvements.update', [$project, $improvement]) }}">
            ...
            <div class="field" style="max-width:320px;">
                ...
                <input id="planned_effort_days" name="planned_effort_days" type="number" min="0.25" max="999.99" step="0.25" value="{{ old('planned_effort_days', $improvement->planned_effort_days) }}" placeholder="例：3">
                <div class="meta">期間とは別に、この取り組み全体の作業量を入力します。</div>
