        ...
        <form class="stack" method="POST" action="{{ route('projects.store') }}">
            ...
            <div class="grid">
                <div class="field">
                    ...
                    <input id="duration_days" name="duration_days" type="number" min="1" max="3650" value="{{ old('duration_days') }}" placeholder="例：29">
                    <div class="meta">休日を含む暦日です。開始日が未確定でも提案できます。</div>
