...
class CompanyLoanMigrationTest extends TestCase
{
    ...
    public function test_loan_migrations_are_safe_to_resume(): void
    {
        ...
        (require database_path('migrations/2026_07_29_000001_add_scheduled_payment_count_to_company_loans.php'))->up();
        (require database_path('migrations/2026_07_29_000002_add_first_payment_on_to_company_loans.php'))->up();
        ...
        $this->assertTrue(Schema::hasColumn('company_loans', 'scheduled_payment_count'));
        $this->assertTrue(Schema::hasColumn('company_loans', 'first_payment_on'));
